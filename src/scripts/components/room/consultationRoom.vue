<template>
    ...
    <div class="row">
    <div class="col-md-4">
    <b-button variant="primary" :to="{path: '/rooms'}"> <!-- BUTTON TO CONSULT room-->
        Back
    </b-button>

    <b-button variant="primary" :to="{name:'editRoom', params: { room: this.room}}"> <!-- BUTTON TO CONSULT room-->
        Edit
    </b-button>

     <b-button variant="primary" @click.prevent="excludeRoom()"> <!-- BUTTON TO CONSULT room-->
       Delete
    </b-button>
       </div>
    </div>
